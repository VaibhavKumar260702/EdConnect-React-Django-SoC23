...
const StudentDiscussionComp = ({ studentInfo ,taID}) => {
  ...
  const OpenDiscussion = (e, id,discussion) => {
    e.preventDefault();
    navigate(`/studentCoursePage/${studentID}/${coursecode}/discussionFollowUps`,{state:[studentInfo,id,discussion]});
  };
          ...
          >
            <Card className="my-2 mx-3 highlighted-div">
              <Card.Body>
                ...
                {discussion.Roll === studentInfo.Roll ?<button onClick={(e)=>handleClick(e,discussion)} className="btn btn-sm btn-info">Edit</button>:null}
                </Card.Title>
